                            ...
                            <?php if($list->count() > 0): ?>
                                <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $elt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="my-auto text-center"><span class="text-white"><?php echo e($elt->eventDate); ?></span></td>
                                    </tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('pages.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vortex/Public/elites/africatravels/resources/views/pages/managers/event.blade.php ENDPATH**/ ?>