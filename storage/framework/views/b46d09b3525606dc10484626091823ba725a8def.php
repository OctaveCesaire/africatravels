        ...
        <header class="d-flex align-items-center justify-content-center mt-6 flex-column text-center text-white">
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-item">
                        <img src="<?php echo e(asset('assets/pages/vue de haut.jpg')); ?>" class="d-block w-100" style="height:70%" alt="La vue de haut du Bénin">
                    ...
                    <div class="carousel-item">
                        <img src="<?php echo e(asset('assets/pages/route des esclave.jpg')); ?>" class="d-block w-100" alt="La route des esclaves">
                        <div class="carousel-caption d-none d-md-block">
                            <h5 class="text-white fw-bolder">La Route des Esclaves</h5>
                            <p>Revivez le passé de la colonisation béninoise à travers la <strong>route des esclaves.</strong></p>
                        </div>
                    ...
                    <div class="carousel-item active">
                        <img src="<?php echo e(asset('assets/pages/culture beninoise.jpg')); ?>" class="d-block w-100" alt="La culture Béninoise : Vodun">
                        <div class="carousel-caption d-none d-md-block">
                    ...
                    <div class="carousel-item">
                        <img src="<?php echo e(asset('assets/pages/rois.jpg')); ?>" class="d-block w-100" alt="Rois du Danxomè">
                        <div class="carousel-caption d-none d-md-block">
        ...
        <section class="d-flex align-items-center justify-content-center flex-column text-center pt-4" style="background-color:#F6F9FF">
            ...
            <div class="container mt-2">
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-3">
                    ...
                    <div class="col mb-3">
                        <div class="card h-100">
                            <img src="<?php echo e(asset('assets/pages/lune_miel.avif')); ?>" 
                                class="card-img-top mx-auto mt-3 rounded-circle" 
                                style="width: 150px;" 
                                alt="Lune De Miel">
                            <div class="card-body">
                    ...
                    <div class="col mb-3">
                        <div class="card h-100">
                            <img src="<?php echo e(asset('assets/pages/escapades.png')); ?>" 
                                class="card-img-top mx-auto mt-3 rounded-circle" 
                                style="width: 150px;" 
                    ...
                    <div class="col mb-3">
                        <div class="card h-100">
                            <img src="<?php echo e(asset('assets/pages/famille.webp')); ?>" 
                                class="card-img-top mx-auto mt-3 rounded-circle" 
                                style="width: 150px;" 
        ...
        <section class="container mb-3 pt-4 text-center" >
            ...
            <div class="container mt-2">
                <div class="row">
                    ...
                    <?php if(-1 > 0): ?>
                        <?php $__currentLoopData = $dest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-12 col-lg-6 mb-3">
                                <div class="card h-100">
                                    <img src="<?php echo e(asset('assets/upload/trips/'.$item->img)); ?>" class="card-img-top dest-img" alt="Destination populaire">
                                    <div class="card-body custom-list">
                                        <h5 class="card-title fw-bold text-center"><?php echo e($item->titre); ?></h5>
                                        <p class="card-text text-center">
                    ...
                    <?php else: ?>
                        <div class="col-md-12 col-lg-6 mb-3">
                            <div class="item" style="background-image: url('<?php echo e(asset('assets/pages/template-python.webp')); ?>');">
                        ...
                        <div class="col-md-12 col-lg-6 mb-3">
                            <div class="item" style="background-image: url('<?php echo e(asset('assets/pages/bio-guerra.png')); ?>');">
                                <div class="item-content">
                        ...
                        <div class="col-md-12 col-lg-6 mb-3">
                            <div class="item" style="background-image: url('<?php echo e(asset('assets/pages/etoile-rouge.jpg')); ?>');">
                                <div class="item-content">
                        ...
                        <div class="col-md-12 col-lg-6 mb-3">
                            <div class="item" style="background-image: url('<?php echo e(asset('assets/pages/amazone.jpg')); ?>');">
                                <div class="item-content">
...
<?php echo $__env->make('pages.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vortex/Public/elites/africatravels/resources/views/pages/clients/index.blade.php ENDPATH**/ ?>