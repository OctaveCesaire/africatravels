                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-3">
                    ...
                    <div class="col mb-3">
                        <div class="card h-100 shadow-lg">
                            <img src="{{asset('assets/pages/P_history_icon_lightgoldenred.png')}}" class="card-img-top mx-auto mt-3 rounded-circle" style="width: 150px;" alt="Image de la carte">
                            <div class="card-body">
                    ...
                    <div class="col mb-3">
                        <div class="card h-100 shadow-lg">
                            <img src="{{asset('assets/pages/mission.jpg')}}" class="card-img-top mx-auto mt-3 rounded-circle" style="width: 150px;" alt="Image de la carte">
                            <div class="card-body">
                    ...
                    <div class="col mb-3">
                        <div class="card h-100 shadow-lg">
                            <img src="{{asset('assets/pages/vision.webp')}}" class="card-img-top mx-auto mt-3 rounded-circle" style="width: 150px;" alt="Image de la carte">
                            <div class="card-body">
