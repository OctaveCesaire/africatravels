<x-app-layout>
    ...
    <div class="container-fluid py-4">
        <div class="mt-2 row">
                ...
                <div class="row row-cols-1 row-cols-md-2 g-4">
                    ...
                    <div class="col-6">
                        <div class="card shadow-lg border-0 rounded-3">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <p class="text-sm text-muted mb-0">Aujourd'hui</p>
                                    <h4 class="font-weight-bold mb-0 text-dark">$53,000</h4>
                                </div>
                                <div class="icon icon-shape bg-gradient-primary shadow-lg rounded-circle py-0 px-3">
                                    <i class="text-info ni ni-money-coins text-lg"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    <!-- Card 2: Chiffre Total -->
                    <div class="col-6">
                        <div class="card shadow-lg border-0 rounded-3">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <p class="text-sm text-muted mb-0">Chiffre Total</p>
                                    <h4 class="font-weight-bold mb-0 text-dark">$53,000</h4>
                                </div>
                                <div class="icon icon-shape bg-gradient-warning shadow-lg rounded-circle py-0 px-3">
                                    <i class="text-info ni ni-cart text-lg"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        <div class="card shadow-lg border-0 rounded-3 mb-2">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <p class="text-sm text-muted mb-0">Note / Rang</p>
                                    <h4 class="font-weight-bold mb-0 text-dark">4.5 avis / 2nd</h4>
                                </div>
                                <div class="icon icon-shape bg-gradient-primary shadow-lg rounded-circle py-0 px-3">
                                    <i class="text-info ni ni-paper-diploma text-lg"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        <div class="card shadow-lg border-0 rounded-3 mb-2">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <p class="text-sm text-muted mb-0">Total Client</p>
                                    <h4 class="font-weight-bold mb-0 text-dark">53,000</h4>
                                </div>
                                <div class="icon icon-shape bg-gradient-warning shadow-lg rounded-circle py-0 px-3">
                                    <i class="text-info ni ni-world text-lg"></i>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-5">
                <div id="globe" class="position-absolute end-lg-4 end-0 top-10 bottom-lg-3">
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="card mt-2 shadow-lg z-index-2 border-0 rounded-3">
