...
<nav class="navbar navbar-expand-lg bg-body-tertiary" style="background-color: #00441B">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active text-white {{ Route::is('dash') ? 'active bg-info rounded' : '' }}" aria-current="page" href="{{ route('dash') }}">Tableau De Bord</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white {{ Route::is('event') ? 'active bg-info rounded' : '' }}" href="{{ route('event') }}">Evenements</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white {{ Route::is('tansactions') ? 'active bg-info rounded' : '' }}" href="{{ route('tansactions') }}">Tansactions</a>
                </li>
            </ul>
      </div>
    </div>
